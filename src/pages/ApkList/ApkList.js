        ...
        <Card className={styles.appCard}>
            {
                loading ? <CircularLoader /> :
                    <div className={styles.container}>
                        ...
                        <Divider />
                        <h2 className={classnames(styles.appCardHeading, styles.appCardSection)}> {i18n.t('All versions of the application')}</h2>
                        {loading ? <CircularLoader /> : <VersionTable versions={versionsData.versions}/>}
                    </div>
            }
        </Card>
    )
